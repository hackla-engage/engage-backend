# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2018-06-21 06:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), default=[], size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agenda_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ingest.AgendaItem')),
                ('committee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ingest.Committee')),
